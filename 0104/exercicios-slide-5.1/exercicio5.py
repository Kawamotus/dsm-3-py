...
labelTelefone = Label(tela,font=fonte, fg=fg, bg=bg, text="Telefone: " ).place(x=10, y=45)
...
btnEnviar = Button(tela,text="Enviar", font="Calibri 10 bold", bg="#1ed", command=mostraDados)
